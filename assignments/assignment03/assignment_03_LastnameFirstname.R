...
## `height` vs. `earn`
ggplot(heights_df, aes(x=height, y=earn)) + geom_point(color = "red")
## `age` vs. `earn`
ggplot(heights_df, aes(x=age, y=earn)) + geom_point(alpha = 1/10)
## `ed` vs. `earn`
ggplot(heights_df, aes(x=ed, y=earn)) + geom_point(shape = 21, colour = "black", fill = "white", size = 5, stroke = 5)

## Re-create the three scatterplots and add a regression trend line using
## the `geom_smooth()` function
## `height` vs. `earn`
ggplot(heights_df, aes(x=height, y=earn)) + geom_point(color = "red") + geom_smooth()
## `age` vs. `earn`
ggplot(heights_df, aes(x=age, y=earn)) + geom_point(alpha = 1/10) + geom_smooth()
## `ed` vs. `earn`
ggplot(heights_df, aes(x=ed, y=earn)) + geom_point(shape = 21, colour = "black", fill = "white", size = 5, stroke = 5) + geom_smooth()
...
ggplot(heights_df, aes(x=height, y=earn, col=sex)) + geom_point() + ggtitle("Earnings by Height and Sex") + xlab("Inches") + ylab("Earnings")
